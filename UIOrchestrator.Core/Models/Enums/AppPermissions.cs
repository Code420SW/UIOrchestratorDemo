...
namespace Code420.UIOrchestrator.Core.Models.Enums
{
    ...
    public enum AppPermissions : ushort
    {
        ...
        //  ----------------------------------------------------
        //  1_000: Bagging section
        //  ----------------------------------------------------
        [Display(GroupName = "Bagging", Description = "Dummy bagging permission")]
        BaggingDummy = 66,

        [Display(GroupName = "Bagging", Description = "Can create new load/bag")]
        BaggingCreate = 1_000,

        [Display(GroupName = "Bagging", Description = "Can delete bags from load")]
        BaggingDelete = 1_002,

        [Display(GroupName = "Bagging", Description = "Access to all Bagging functions")]
        BaggingAdmin = 1_999,
